...
public class OI {
	...
	private JoystickButton manualAlign;
    ...
    public OI() {
     ...
     /*   climberFront = new JoystickButton(driveStick, 5);
        ...
        quarterSpeed.whileHeld(new Drive(-4));
        manualAlign = new JoystickButton(driveStick,2);
        manualAlign.whileHeld(new ManualGearAlign(Robot.gearStep2Dist));
