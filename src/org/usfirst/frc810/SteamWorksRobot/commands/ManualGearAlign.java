 ...
 *
 */
public class ManualGearAlign extends Command {
    ...
    public ManualGearAlign(double UltrasonicValue) {
    ...
    protected void execute() {
    	...
    	Robot.driveTrain.mecanum(forward, Robot.oi.getDriveStick().getY()*.4, pid.get());
    }
